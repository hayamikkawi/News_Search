...
│   │
│   ├── storage/                       # Storage and database layer
│   │   ├── __init__.py
...
│       ├── __init__.py
│       ├── main.py                    # Simple version (JSONL output)
│       └── main_with_coordinator.py   # Full version (DB + Indexer)
│
├── sources/                           # RSS feed sources configuration
│   ├── __init__.py
│   └── feeds.yaml                     # RSS feed list
│
├── scripts/                           # Utility scripts
│   ├── validate_crawler.py            # Crawler validation
│   └── verify_database.py             # Database verification
│
├── examples/                          # Usage examples
│   ├── example_crawler_indexer_integration.py
│   ├── example_mysql_usage.py
│   ├── test_coordinator.py
│   └── test_indexer_format.py
│
├── docs/                              # Documentation
│   └── TODO.md
│
├── tests/                             # Tests (reserved for future)
│
